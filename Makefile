...
ARCH		?=arm64
CROSS_COMPILE= /root/disk/a12/kernel/toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC              = /root/disk/a12/kernel/toolchain/clang/host/linux-x86/clang-r353983c/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /root/disk/a12/kernel/toolchain/clang/host/linux-x86/clang-r353983c/bin/aarch64-linux-gnu-
...
export	INSTALL_PATH ?= /disk2/a12/boot/out/
